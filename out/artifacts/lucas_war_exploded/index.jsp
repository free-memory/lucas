...
<ul>
    ...
    <li>image提交按钮</li>
    <li>input有很多增强的功能并且能自动支持类型验证, type= url, email, number, date, time, datetime-local,week,month,range,color,output
    </li>
...
<ul>
    ...
    <li>Event: <a href="event.html"> click me</a></li>
    <li>home page: <a href="app_home.html"> click me</a></li>
    <li>User form and servlet: <a href="form.html"> click me</a></li>
    <li>jQuery: <a href="jquery.html"> click me</a></li>
    <li>jQuery UI: <a href="jquery_ui.html"> click me</a></li>
</ul>
